<?php 
/*
Сначала мы проверям сессию. Если она не активна, то мы проверемя наличие cookie.
Идея заключается в том, что, если пользователь входит с нового окна браузера (новая сессия),
то, зная cookie, мы создадим новую сессию, которая позволит избежать новой авторизации.
