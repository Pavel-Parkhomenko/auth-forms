...
/* если это закомментировать, то пользователь увидит сообщение Ошибка на сервере.
Это возникат потому, что пользователь ожидает ответ (res.json()), а ответа не будет, 
вот и возникнет исключение, в ктором сработает блок catch
*/
if ($hasUser === false) {
